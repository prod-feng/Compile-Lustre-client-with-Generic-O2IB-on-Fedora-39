...
4. Modify lustre.spec  (please note, each time you run "./configure" command, it will overwite lustre.spec file using the lustre.spec.in. So you can change it instead)
